...
export default function Profile() {
    const serverUrl = process.env.NEXT_PUBLIC_WAZEND_API_URL;
    ...
    const renderComponent = () => {
        console.log("Passing instanceId to Component:", documentId);
        switch (activeComponent) {
            case 'Dashboard':
                return <Dashboard instanceId={documentId} serverUrl={serverUrl} />;
            case 'Config':
                return <Config instanceId={documentId} serverUrl={serverUrl} />;
            case 'Proxy':
                return <Proxy instanceId={documentId} serverUrl={serverUrl} />;
            case 'Integrations':
                return <Integrations instanceId={documentId} serverUrl={serverUrl} />;
            case 'Grupos':
                return <Group documentId={documentId} />;
            default:
                return <Dashboard instanceId={documentId} serverUrl={serverUrl} />;
        }
    };
