...
export default function Profile() {
    ...
    const renderComponent = () => {
        ...
        switch (activeComponent) {
            case 'Dashboard':
                return <Dashboard instanceId={instanceData.instanceName} serverUrl={serverUrl} />;
            case 'Config':
                return <Config instanceId={instanceData.instanceName} serverUrl={serverUrl} />;
            case 'Proxy':
                return <Proxy instanceId={instanceData.instanceName} serverUrl={serverUrl} />;
            case 'Integrations':
                return <Integrations instanceId={instanceData.instanceName} serverUrl={serverUrl} />;
            case 'Grupos':
